...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center py-20">
            <div className="space-y-6 text-white">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <a href="/products" className="bg-gradient-to-r from-amber-500 to-amber-600 text-white px-10 py-4 rounded-xl font-bold hover:from-amber-600 hover:to-amber-700 transition shadow-xl shadow-amber-500/30 hover:shadow-amber-500/50 hover:scale-105 transform duration-300 inline-block">
                  Shop Now
                </a>
                <a href="/products" className="border-2 border-amber-400 text-amber-300 px-10 py-4 rounded-xl font-bold hover:bg-amber-400/10 transition backdrop-blur-sm inline-block">
                  View Catalog
                </a>
              </div>
              <div className="flex items-center gap-8 pt-6">
                <div className="flex items-center gap-3">
                  <div className="flex -space-x-3">
                    {[1, 2, 3, 4].map((i) => (
                      <div key={i} className="w-12 h-12 rounded-full bg-gradient-to-br from-amber-400 to-amber-600 border-3 border-blue-900 shadow-lg" />
                    ))}
                  </div>
                  <div>
                    ...
                    <p className="text-sm text-blue-200 mt-1 font-semibold">5,000+ Happy Customers</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      {/* Features Bar */}
      <section className="bg-gradient-to-r from-blue-900 via-blue-800 to-blue-900 text-white py-8 md:py-10 lg:py-12 border-y-4 border-amber-400/20 px-4 md:px-8 lg:px-12">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="flex flex-col md:flex-row items-center gap-4 text-center md:text-left group">
              <div className="bg-gradient-to-br from-amber-400 to-amber-600 p-4 rounded-2xl shadow-xl shadow-amber-500/30 group-hover:scale-110 transition duration-300">
                <Truck size={32} className="flex-shrink-0" />
              </div>
              <div>
                <p className="font-bold text-lg">Free Shipping</p>
                <p className="text-sm text-amber-200">Orders over ₦200</p>
              </div>
            </div>
            <div className="flex flex-col md:flex-row items-center gap-4 text-center md:text-left group">
              <div className="bg-gradient-to-br from-amber-400 to-amber-600 p-4 rounded-2xl shadow-xl shadow-amber-500/30 group-hover:scale-110 transition duration-300">
              ...
              <div>
                <p className="font-bold text-lg">2 Year Warranty</p>
                <p className="text-sm text-amber-200">On all products</p>
              </div>
            </div>
            <div className="flex flex-col md:flex-row items-center gap-4 text-center md:text-left group">
              <div className="bg-gradient-to-br from-amber-400 to-amber-600 p-4 rounded-2xl shadow-xl shadow-amber-500/30 group-hover:scale-110 transition duration-300">
              ...
              <div>
                ...
                <p className="text-sm text-amber-200">Certified products</p>
              </div>
            </div>
            <div className="flex flex-col md:flex-row items-center gap-4 text-center md:text-left group">
              <div className="bg-gradient-to-br from-amber-400 to-amber-600 p-4 rounded-2xl shadow-xl shadow-amber-500/30 group-hover:scale-110 transition duration-300">
              ...
              <div>
                ...
                <p className="text-sm text-amber-200">Expert assistance</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="categories" className="py-12 md:py-16 lg:py-20 px-4 md:px-8 lg:px-12 bg-gradient-to-br from-slate-50 via-blue-50 to-slate-50">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-12 md:mb-16">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-100 to-amber-50 px-4 py-2 rounded-full mb-4 border-2 border-amber-200">
              <Sparkles size={16} className="text-amber-600" />
              <span className="text-sm font-bold text-amber-700">CATEGORIES</span>
            </div>
                  ...
                  {categories.map((category: any, index: number) => {
                    ...
                    return (
                      <Link
                        ...
                        className="group relative bg-white rounded-2xl p-6 md:p-8 shadow-lg hover:shadow-2xl transition-all duration-300 cursor-pointer overflow-hidden border-2 border-transparent hover:border-amber-400 flex-shrink-0 w-72 md:w-80"
                      >
      ...
      <section id="products" className="py-12 md:py-16 lg:py-20 px-4 md:px-8 lg:px-12 bg-white">
        <div className="container mx-auto px-4 md:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-100 to-blue-50 px-4 py-2 rounded-full mb-4 border-2 border-blue-200">
              <Star size={16} className="text-blue-600 fill-blue-600" />
              <span className="text-sm font-bold text-blue-700">FEATURED</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Featured Products</h2>
            <p className="text-xl text-gray-600">Our most popular lighting solutions</p>
          </div>
          ...
          <div className="text-center mt-16">
            <a href="/products" className="inline-block border-3 border-blue-600 text-blue-700 px-10 py-4 rounded-xl font-bold hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-800 hover:text-white hover:border-transparent transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105 transform">
              View All Products →
            </a>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500/20 to-amber-600/20 backdrop-blur-sm px-4 py-2 rounded-full mb-4 border-2 border-amber-400/30">
              ...
              <span className="text-sm font-bold text-amber-300">WHY CHOOSE US</span>
            </div>
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Why Choose AKT Lighting?</h2>
            <p className="text-xl text-blue-200">Your trusted partner in premium lighting solutions</p>
          </div>
          <div className="grid md:grid-cols-3 gap-10">
            {[
              ...
              <div key={index} className="text-center group">
                <div className="bg-gradient-to-br from-amber-500 to-amber-600 w-24 h-24 rounded-3xl flex items-center justify-center mx-auto mb-6 shadow-2xl shadow-amber-500/50 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300 border-4 border-amber-300/20">
                  <item.icon size={44} className="text-white" />
                </div>
                <h3 className="text-2xl font-bold mb-4 text-amber-100">{item.title}</h3>
                <p className="text-blue-200 leading-relaxed text-lg">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto">
                <input
                  ...
                  className="flex-1 px-6 py-4 border-2 border-blue-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-amber-400 transition shadow-sm"
                />
                <button className="bg-gradient-to-r from-blue-600 to-blue-800 text-white px-10 py-4 rounded-xl font-bold hover:from-amber-500 hover:to-amber-600 transition-all duration-300 whitespace-nowrap shadow-xl hover:shadow-2xl hover:scale-105 transform">
                  Subscribe Now
                </button>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-bold bg-gradient-to-r from-amber-400 to-amber-600 bg-clip-text text-transparent">AKT</h3>
                  <p className="text-xs font-semibold text-amber-500 tracking-wider">LIGHTING</p>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                {['facebook', 'twitter', 'instagram', 'linkedin'].map((social) => (
                  <button
                    key={social}
                    className="w-11 h-11 bg-slate-800 hover:bg-gradient-to-br hover:from-blue-600 hover:to-amber-600 rounded-xl transition-all duration-300 flex items-center justify-center shadow-lg hover:shadow-amber-500/30 hover:scale-110 transform"
                  >
            ...
            {/* Quick Links */}
            <div>
              <h4 className="text-amber-400 font-bold mb-6 text-lg">Quick Links</h4>
              <ul className="space-y-3">
                {['About Us', 'Our Products', 'Contact', 'Blog', 'FAQs', 'Careers'].map((link) => (
                  <li key={link}>
                    <a href="#" className="hover:text-amber-400 transition-colors duration-200 inline-block hover:translate-x-1 transform">{link}</a>
                  </li>
                ))}
              </ul>
            </div>
            ...
            {/* Categories */}
            <div>
              <h4 className="text-amber-400 font-bold mb-6 text-lg">Categories</h4>
              <ul className="space-y-3">
                {['Home Lighting', 'Commercial', 'LED Solutions', 'Decorative', 'Outdoor', 'Smart Lighting'].map((category) => (
                  <li key={category}>
                    <a href="#" className="hover:text-amber-400 transition-colors duration-200 inline-block hover:translate-x-1 transform">{category}</a>
                  </li>
                ))}
              </ul>
            </div>
            ...
            {/* Contact */}
            <div>
              <h4 className="text-amber-400 font-bold mb-6 text-lg">Contact Us</h4>
              <ul className="space-y-4">
                <li className="flex items-start gap-3 group">
                  <MapPin size={20} className="text-amber-500 flex-shrink-0 mt-1 group-hover:scale-110 transition-transform" />
                  <span className="group-hover:text-amber-100 transition">123 Lighting Street, NY 10001, USA</span>
                </li>
                <li className="flex items-center gap-3 group">
                  <Phone size={20} className="text-amber-500 flex-shrink-0 group-hover:scale-110 transition-transform" />
                  <span className="group-hover:text-amber-100 transition">+1 (234) 567-890</span>
                </li>
                <li className="flex items-center gap-3 group">
